        ...
        <div className="container" style={{ gridTemplateColumns: '1fr' }}>
            <div className="card" style={{ marginBottom: '25px' }}>
                ...
                <div className="match-list">
                    <div className="match-item" style={{ flexDirection: 'column', alignItems: 'flex-start' }}>
                        <strong style={{ color: 'var(--sas-blue)' }}>Repechaje y Semifinales (22 y 23/12)</strong>
                    ...
                    <div className="match-item" style={{ flexDirection: 'column', alignItems: 'flex-start' }}>
                        <strong style={{ color: 'var(--sas-red)' }}>Gran Final (26/12)</strong>
                        <ul style={{ marginLeft: '20px', marginTop: '10px', color: 'var(--text-dim)' }}>
                    ...
                    <div className="match-item">
                        <span>Cancha: <strong>Fútbol 8</strong></span>
                    </div>
                </div>
            </div>
            ...
            <div className="card">
                ...
                <div style={{ padding: '20px' }}>
                    <div className="stats-row" style={{ gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))' }}>

                        <div className="stat-card">
                            <div className="stat-label">Sustituciones</div>
                            <div className="player-name">Cambios ilimitados durante todo el encuentro.</div>
                        </div>
                        ...
                        <div className="stat-card">
                            ...
                            <div className="player-name">En caso de empate en tiempo regular, se definirá por penales.</div>
                        </div>

                        <div className="stat-card">
                            <div className="stat-label">Conducta</div>
                            <div className="player-name">Fair Play obligatorio. El respeto al árbitro y rival es prioridad.</div>
                        </div>
            ...
            <div className="card" style={{ marginTop: '25px', overflow: 'hidden' }}>
                ...
                <div className="awards-banner">
                    <img src="assets/img/trofeos con foto.PNG" alt="Trofeos SAS CUP" className="main-trophy-img" />
                ...
                <div style={{ padding: '20px', textAlign: 'center', background: 'var(--bg-deep)' }}>
                    <p style={{ color: 'var(--text-dim)', fontSize: '0.85rem' }}>
                        La entrega se realizará tras la <strong style={{ color: 'var(--sas-red)' }}>Gran Final</strong> el 26/12.
                    </p>
                </div>

                <div className="card venue-card" style={{ gridColumn: '1 / -1', marginTop: '10px' }}>

                    <svg className="venue-icon" viewBox="0 0 24 24" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
