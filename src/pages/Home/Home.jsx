      ...
      <div className="container">
        <div className="card">
          <div className="card-header">
            ...
            <img
              src="src\assets\images\sascup.jpg"
              alt="League Logo"
          ...
          <ul className="match-list">
            <li className="match-item">
              ...
              <span className="team-vs" style={{ fontSize: "1.2rem" }}>
                6 - 0
              </span>
              <div className="team-info">
                <img
            ...
            <li
              ...
              style={{ borderLeft: "4px solid #cd7f32" }}
            >
              <div className="team-info">
                <img
                  src="src\assets\images\logos sin fondo\cacn.webp"
            ...
            <li
              ...
              style={{
                ...
                background:
                  "linear-gradient(to right, rgba(192, 192, 192, 0.05), rgba(251, 191, 36, 0.05))",
              }}
            >
              <div className="team-info" style={{ position: "relative" }}>
                ...
                <img
                  src="src\assets\images\logos con fondo\cacn-.webp"
                  alt="CACN"
                  className="team-logo"
                />
                <span>CACN</span>
        ...
        <div className="right-grid">
          <div className="card mvp-card" style={{ marginBottom: "20px" }}>
            ...
            <div className="mvp-image-container">
              <img
                src="src\assets\images\mejores jugadores\mvp cacn.jpg"
                alt="MVP Semifinal 1"
              />
            </div>
          </div>
          ...
          <div className="card mvp-card">
            ...
            <div className="mvp-image-container">
              <img
                src="src\assets\images\mejores jugadores\mvp hermas.jpg"
                alt="MVP Semifinal 2"
              />
            </div>
          </div>
          ...
          <div className="bracket-wrapper with-lines">
              ...
              <div className="matchup match-semi-l">
                <div className="team-slot slot-green">
                  <img
                    src="src\assets\images\logos con fondo\cacn-.webp"
                    alt="CACN FC"
                    className="team-logo-formatotorneo"
                  />
                </div>
                <div className="team-slot slot-green">
                  <img
                    src="src\assets\images\logos con fondo\semenup.webp"
                    alt="SEMENUP FC"
                    className="team-logo-formatotorneo"
                  />
                </div>
            ...
            <div className="bracket-col bracket-col-center">
              <div style={{ textAlign: "center", marginBottom: "10px" }}>
                <img
                  src="src\assets\images\parche campeon.png"
                  alt="Trofeo SAS CUP"
                  style={{
                    width: "80px",
              ...
              <div className="round-title t-center">
                Gran Final <br />
                <span>26/12 17:00 HS</span>
                <br />
                <span
                  style={{
                    color: "#10b981",
              ...
              <div className="matchup final match-final">
                ...
                >
                  ...
                  <img
                    src="src\assets\images\logos con fondo\hermas.webp"
                    alt="HERMAS FC"
                    className="team-logo-formatotorneo"
                  />
                </div>
              ...
              <div className="round-title mt-10 t-center">
                Tercer Puesto <br />
                <span>26/12 16:00 HS</span>
                <br />
                <span
                  style={{
                    color: "#10b981",
                ...
                >
                  <div
                    style={{
                      ...
                      fontSize: "0.7rem",
                      fontWeight: "bold",
                      boxShadow: "0 2px 8px rgba(205, 127, 50, 0.5)",
                      zIndex: 10,
                    }}
                  >
                    🥉 3ER PUESTO
                  ...
                  <img
                    src="src\assets\images\logos con fondo\llorvi.webp"
                    alt="LLORVI"
                    className="team-logo-formatotorneo"
                  />
                </div>
            ...
            <div className="bracket-col bracket-col-right">
              <div className="round-title t-right">
                Semifinales <br />
                <span>23/12 16:00 HS</span>
              </div>
              ...
              <div className="round-title mt-20 t-right">
                Repechaje (Finalizado) <br />
                <span>6 - 0</span>
              </div>
              <div className="matchup play-in match-playin">
                ...
                <div className="team-slot slot-orange">
                  <img
                    src="src\assets\images\logos apagados\los explosivos con fondo apagado.webp"
                    alt="losexplosivos FC"
                    className="team-logo-formatotorneo"
                  />
                </div>
              </div>
        ...
        >
          <div className="gallery-content">
            ...
            <p>
              Reviví los mejores momentos. Fotos y videos exclusivos de cada
              fecha.
            </p>
          </div>
          <a
            href="https://drive.google.com/drive/folders/1ECHt9hNI_vWzLYMVMDzqOmc523grMlfh?usp=drive_link"
            target="_blank"
      ...
      <footer>
        <div className="footer-content">
          ...
          <p className="developer">
            Desarrollado por{" "}
            <span className="dev-name">Francisco De Cilia</span>
          </p>
        </div>
      </footer>
    </div>
